...
library(MASS)
library(glmnet)
step.model <- stepAIC(logreg1, direction = "both")
...
#Accuracies
barplot(c(ACC.model.logistic.interaction, ACC.model.logistic, ACC.model.tree, ACC.model.randomforest), xpd=FALSE, ylim=c(.75,.9), xlab="Method", names = c("\n logistic \n interaction", "\n logistic \n", "\n classif. \n tree", "\nRandom forest"), ylab = "Accuracy")
